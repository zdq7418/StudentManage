...
/**
 	* A data access object (DAO) providing persistence and search support for UserGroup entities.
 			* Transaction control of the save(), update() and delete() operations 
		can directly support Spring container-managed transactions or they can be augmented	to handle user-managed Spring transactions. 
		Each of these methods provides additional information for how to configure it for the desired type of transaction control. 	
	 * @see com.student.bean.UserGroup
...
public class UserGroupDAO extends HibernateDaoSupport  {
	...
	public static final String GRP_STATUS = "grpStatus";
	public static final String OPER_UER = "operUer";
    ...
    public UserGroup findById( java.lang.Integer id) {
        ...
        try {
            UserGroup instance = (UserGroup) getHibernateTemplate()
                    .get("com.student.bean.UserGroup", id);
            return instance;
        } catch (RuntimeException re) {
	...
	public List findByGrpStatus(Object grpStatus
	) {
		return findByProperty(GRP_STATUS, grpStatus
		);
	}
	
	public List findByOperUer(Object operUer
	) {
		return findByProperty(OPER_UER, operUer
		);
	}
